...
class TitleScreenUi extends StatelessWidget {
  // Bu sınıf, oyun için menü sayfasının arayüzünü oluşturur.
  const TitleScreenUi({
    super.key,
  ...
  final int difficulty; // Bu değişkenler, sınıfın parametrelerini tutar.
    ...
    return Padding(
      ...
      child: Stack(
        children: [
          ...
          /// Difficulty Selector
          // Bu widget, zorluk seviyesi seçicisini gösterir.
          BottomLeft(
            child: UiScaler(
...
class _TitleText extends StatelessWidget {
  // Bu sınıf, menü sayfasının başlık metnini oluşturur.
  const _TitleText();
  ...
  Widget build(BuildContext context) {
    Widget content = Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            Transform.translate(
              ...
              child: Text('LOSERS CLUB', style: TextStyles.h1),
            ),
        ...
        Text('SERT YENİLENLER', style: TextStyles.h3)
            .animate()
        ...
        return SizedBox(
          ...
          child: Stack(
            children: [
              ...
              duration: .7.seconds, color: Color.fromARGB(255, 34, 215, 228)),
        )
            .animate()
